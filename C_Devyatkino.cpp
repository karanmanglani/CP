...
int main() {
    ...
    while(t--) {
        lli n;cin >> n;
        if(n < 10) {cout << chk(n,9) << endl;}
        else if(n < 100) {cout << min(chk(n,9), chk(n,99)) << endl;}
        else if(n < 1000) {cout << min(chk(n,9) , min(chk(n,99),chk(n,999))) << endl;}
        else if(n < 1e4) {cout << min({chk(n,9), chk(n,99), chk(n,999), chk(n,9999)}) << endl;}
        else if(n < 1e5) {cout << min({chk(n,9), chk(n,99), chk(n,999), chk(n,9999), chk(n,99999)}) << endl;}
        else if(n < 1e6) {cout << min({chk(n,9), chk(n,99), chk(n,999), chk(n,9999), chk(n,99999), chk(n,999999)}) << endl;}
        else if(n < 1e7) {cout << min({chk(n,9), chk(n,99), chk(n,999), chk(n,9999), chk(n,99999), chk(n,999999), chk(n,9999999)}) << endl;}
        else if(n < 1e8) {cout << min({chk(n,9), chk(n,99), chk(n,999), chk(n,9999), chk(n,99999), chk(n,999999), chk(n,9999999), chk(n,99999999)}) << endl;}
        else if(n < 1e9) {cout << min({chk(n,9), chk(n,99), chk(n,999), chk(n,9999), chk(n,99999), chk(n,999999), chk(n,9999999), chk(n,99999999), chk(n,999999999)}) << endl;}
        else {cout << min({chk(n,9), chk(n,99), chk(n,999), chk(n,9999), chk(n,99999), chk(n,999999), chk(n,9999999), chk(n,99999999), chk(n,999999999), chk(n,9999999999)}) << endl;}
    }
    return 0;
}