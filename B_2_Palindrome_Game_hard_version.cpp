...
int main() {
    ...
    while(t--) {
        ...
        if(pcnt == cnt){
            // String is palindrome by default i.e the condition for easy version
            if(cnt == 0){
                cout << "DRAW" << endl;
                continue;
            }
            ...
            // String is not palindrome by default
            lli np = cnt - pcnt; 
            lli a = 0, b = np;
            // Now alice turn with start and string is palindromic
            if(pcnt == 0){
                cout << "ALICE" << endl;
                continue;
            }
