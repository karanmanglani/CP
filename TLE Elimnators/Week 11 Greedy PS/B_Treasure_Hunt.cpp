...
int main() {
    ...
    while(t--) {
        ...
        auto mx = [=](string s){
            ...
            lli lft = s.length() - mxm;
            if(n <= lft) {
                lft -= n;
                mxm += n;
            }else {
                if(mxm == s.size() and n == 1) mxm--;
                else mxm = s.size();
            }
        ...
        lli x = mx(a), y = mx(b), z = mx(c);
        lli mxm = max({x,y,z});
        if((x == mxm && y == mxm) || (x == mxm && z == mxm) || (y == mxm && z == mxm)){cout << "Draw" << endl;}
        else if(x == mxm){cout << "Kuro" << endl;}
        else if(y == mxm){cout << "Shiro" << endl;}
